...
| číslem **EL NAD 742** –  | československých |              |        |        |        |        |        |        |         |
| jediný záznam na první   | turistů          |              |        |        |        |        |        |        |         |
| úrovni                   |                  |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
...
| na třetí úrovni          |                  |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
| Série 2. úrovně – v      | Rusínské spolky  | 742          | 1      | 1      | **15** | -      | -      | -      | -       |
| pořadí **patnáctý**      | na Podkarpatské  |              |        |        |        |        |        |        |         |
| záznam na čtvrté úrovni  | Rusi             |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
| Série 3. úrovně – v      | Spolek učitelů   | 742          | 1      | 1      | 15     | **2**  | -      | -      | -       |
| pořadí **druhý** záznam  | na Podkarpatské  |              |        |        |        |        |        |        |         |
| na páté úrovni           | Rusi             |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
...
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
| Jednotlivost – fotoalbum | „Spolek učitelů  | 742          | 1      | 1      | 15     | 2      | 1      | **10** | -       |
| – v pořadí **desátý**    | na Podkarpatské  |              |        |        |        |        |        |        |         |
| záznam na sedmé úrovni   | Rusi 1937“       |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
| Část jednotlivosti –     | Výstava u        | 742          | 1      | 1      | 15     | 2      | 1      | 10     | **1-1** |
| fotografie v albu –      | příležitosti     |              |        |        |        |        |        |        |         |
| dodatečně doplněný v     | kongresu, pohled |              |        |        |        |        |        |        |         |
| pořadí **první** záznam  | na expozici      |              |        |        |        |        |        |        |         |
| na osmé úrovni           |                  |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
| Část jednotlivosti –     | Skupinová        | 742          | 1      | 1      | 15     | 2      | 1      | 10     | **1**   |
| fotografie v albu – v    | fotografie,      |              |        |        |        |        |        |        |         |
| pořadí původně **první** | zaplněný jednací |              |        |        |        |        |        |        |         |
| záznam na osmé úrovni    | sál              |              |        |        |        |        |        |        |         |
+--------------------------+------------------+--------------+--------+--------+--------+--------+--------+--------+---------+
...
+--------------------------------------+-----------------+-----------------------+
| **Typ označení**                     | **Specifikace** | **Hodnota**           |
+--------------------------------------+-----------------+-----------------------+
| Signatura přidělená původcem         | sign. pův.      | XIII/2                |
+--------------------------------------+-----------------+-----------------------+
| Signatura přidělená při zpracování   | sign.           | VI.                   |
| archiválie                           |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Ukládací/Spisový znak                | ukl./sp. znak   | 302.1                 |
+--------------------------------------+-----------------+-----------------------+
| Číslo jednací                        | čj.             | 125/2008              |
+--------------------------------------+-----------------+-----------------------+
| Spisová značka                       | sp. zn.         | C128/1978             |
+--------------------------------------+-----------------+-----------------------+
| Číslo vložky úřední knihy            | č. vl.          | 204                   |
+--------------------------------------+-----------------+-----------------------+
| Přírůstkové číslo                    | č. př.          | 2009/001              |
+--------------------------------------+-----------------+-----------------------+
| Neplatné pořadové číslo              | nepl. poř. č.   | 7                     |
| manipulačního seznamu (ze zrušené    |                 |                       |
| pomůcky)                             |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Neplatné inventární číslo (ze        | nepl. inv. č.   | 25                    |
| zrušené pomůcky)                     |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Signatura přidělená při předchozím   | nepl. sign.     | 1. 12. 138            |
| zpracování                           |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Delimitovaná úřední kniha nově       | nepl. sign.     | č. 75 (2022)          |
| inventarizovaná (údaj „Státní        |                 |                       |
| oblastní archiv v Hradci Králové,    |                 |                       |
| Sbírka pozemkových knih, PozK        |                 |                       |
| Hlinsko“ se uvádí v prvku popisu     |                 |                       |
| **4.3.2 Dějiny jednotky popisu**)    |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Neplatné referenční označení         | nepl. ref. ozn. | CZ321100010//4//2//38 |
+--------------------------------------+-----------------+-----------------------+
| Jednotka se dvěma signaturami        | sign. pův.      | X/5, II/1             |
| přidělenými původcem (na prvním      |                 |                       |
| místě je signatura, podle které byla |                 |                       |
| jednotka zařazena do struktury       |                 |                       |
| fondu)                               |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Jednotka s velkým množstvím          | sign. pův.      | X/5/2-158, II/17-38   |
| dokumentů s různými signaturami      |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Jednotka s více jednacími čísly      | čj.             | 53-1580/1908,         |
|                                      |                 | 2-45/1909             |
+--------------------------------------+-----------------+-----------------------+
| Pořadové číslo pro tisk              | poř. č.         | 1                     |
+--------------------------------------+-----------------+-----------------------+
| Číslo pohlednice nakladatelství      | nakl. č.        | 1-78132, 151 10 202   |
| Orbis (kód pomáhá určit mimo jiné    |                 | 1, 20 8517 1276       |
| dataci pohlednice)                   |                 |                       |
+--------------------------------------+-----------------+-----------------------+
| Číslo negativu                       | č. neg.         | 2001/88               |
+--------------------------------------+-----------------+-----------------------+
| Číslo produkce CD                    | č. prod.        | WR2CD-5034            |
+--------------------------------------+-----------------+-----------------------+
| Kódy ISBN, ISSN, ISMN                | ISBN            | 80-85499-07-X         |
+--------------------------------------+-----------------+-----------------------+
| Matriční číslo (propůjčeného         | matr. č.        | 237                   |
| vyznamenání)                         |                 |                       |
+--------------------------------------+-----------------+-----------------------+
